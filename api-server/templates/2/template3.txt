 ...
 * @recommendation Ensure that the size parameter is derived from the size of destination buffer not source buffer
 * @link https://codeql.github.com/codeql-query-help/cpp/cpp-bad-strncpy-size/
 */
