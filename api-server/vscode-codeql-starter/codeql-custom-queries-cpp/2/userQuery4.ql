 ...
 *              The return value of a call to snprintf is the number of characters that wld have been written to the buffer 
 *              if there is sufficient space. 
 *              When the operation reaches the end of the buffer and more than 1 char is discarded, the return value
 *              will be greater than the buffer size
 * @kind problem
 * @id cpp/overflowing-snprintf
 * @recommendation The return value of snprintf should always be checked if it is used, and values larger than buffer size
 *                 should be accounted for
 * @link https://codeql.github.com/codeql-query-help/cpp/cpp-overflowing-snprintf/
 */
